...
**Versión:** 1.0
**Estado:** Aceptado (implementado en el Sprint 31)
**Fecha:** 2026-06-03
...
| **Teselas del mapa** (imágenes de cada zoom/tile) | `https://tile.openstreetmap.org/{z}/{x}/{y}.png` por red | **No**: se descargan bajo demanda al navegar el mapa |
...
2. **Service Worker (PWA)**: cachear las teselas visitadas para volver a verlas sin red. Cubre las zonas ya navegadas, no zonas nuevas.
...
La elección depende del requisito real de offline; el MVP usa la opción directa con atribución y deja documentadas las demás.
