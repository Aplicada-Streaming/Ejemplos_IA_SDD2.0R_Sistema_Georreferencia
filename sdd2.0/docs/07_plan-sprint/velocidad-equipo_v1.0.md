...
> Tracking actualizado al cierre del Sprint 31. La tabla §1 registra la velocity efectiva de los Sprint 00 a 31 ya ejecutados. El promedio móvil de 3 sprints se puebla desde S02 (con S00, S01, S02).
...
Treinta y dos sprints registrados (S00: 21, S01: 40, S02: 27, S03: 28, S04: 24, S05: 13, S06: 13, S07: 16, S08: 11, S09: 13, S10: 13, S11: 13, S12: 13, S13: 8, S14: 8, S15: 11, S16: 8, S17: 10, S18: 8, S19: 8, S20: 8, S21: 8, S22: 8, S23: 8, S24: 8, S25: 8, S26: 8, S27: 8, S28: 8, S29: 8, S30: 8, S31: 8). El promedio móvil de 3 sprints se mantuvo en 8,0 SP (ventana S29–S31): catorce sprints consecutivos de 8 SP (S18–S31), una cadencia muy estable de alcance acotado (E2E, supply-chain, pulido de producto, consolidación de pruebas, release y mapa). La desviación de S31 respecto de su ventana previa es 0 %. Descontados los efectos de planificación, los sprints de módulo completo del arranque (S02: 27, S03: 28, S04: 24) siguen marcando el techo de 24–28 SP. Con el release stable v1.0.0 publicado y el mapa interactivo entregado y endurecido (Leaflet vendorizado, sin CDN), el MVP de producto queda completo; lo restante es mantenimiento post-release y mejoras opcionales (mapa OSM en el móvil, caché de teselas para offline).

## 3. Capacidad ajustada

Con el promedio móvil de 3 sprints en 8,0 SP (S31), la capacidad sugerida estricta para S32 sería de hasta 9 SP (110 % del promedio móvil). Con el MVP de producto completo (release v1.0.0 publicado, mapa interactivo entregado y endurecido), el trabajo restante son mejoras opcionales (mapa OSM en el móvil con Mapsui/WebView, Service Worker/caché de teselas para offline real) y mantenimiento post-release (Dependabot/CVE por SLA, incluir las libs vendorizadas de `wwwroot` en el seguimiento de versiones). La velocity se sigue comparando sobre el equipo con frente backend + móvil; el promedio móvil de 8,0 SP refleja la cadencia de alcance acotado (una historia por sprint), no un límite real de capacidad: los módulos completos del arranque marcaron 24–28 SP.
