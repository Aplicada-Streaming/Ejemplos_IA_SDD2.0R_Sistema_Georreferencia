...
Índice navegable de los planes de sprint de GeoVial, las plantillas reusables de ceremonias y el tracking de velocidad. Punto de entrada para revisores externos (AG-06 Product Owner / Backlog, AG-08 QA, AG-09 DevOps) y para nuevos integrantes del equipo.

## Sprint vigente

| Sprint | Estado | Fechas | Plan |
| --- | --- | --- | --- |
| Sprint 37 | Por planificar (offline de teselas en el móvil; auto-merge de Dependabot para minor/patch; o prueba de S3 contra LocalStack) | — | — |
...
| Plantilla | Archivo |
| --- | --- |
| Sprint review (7 secciones) | [template-sprint-review_v1.0.md](template-sprint-review_v1.0.md) |
| Sprint retrospectiva (5 secciones) | [template-sprint-retrospectiva_v1.0.md](template-sprint-retrospectiva_v1.0.md) |

## Velocidad del equipo

Tracking acumulado de velocity sprint a sprint con promedio móvil de 3 sprints: [velocidad-equipo_v1.0.md](velocidad-equipo_v1.0.md).
