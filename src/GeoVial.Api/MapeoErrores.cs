...
public static class MapeoErrores
{
    public static IResult AProblema(string? codigo) => codigo switch
    {
        ...
        CodigosError.ConsolidacionInvalida => Problema(codigo, StatusCodes.Status409Conflict, "No se pudo aplicar la última escritura"),
        CodigosError.ConflictoNoMarcado => Problema(codigo, StatusCodes.Status409Conflict, "El recurso consolidado no quedó marcado como conflicto"),
